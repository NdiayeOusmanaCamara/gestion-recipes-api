...
import  {addRequestValidator,deleteRequestValidator,updateValidator,getByIdValidator}  from '../validators/recipeValidator.js'; 
...
router.patch('/recipes/:id',updateValidator, RecipeController.updateRecipe);
